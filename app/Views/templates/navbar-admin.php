...
<div class="col-md-3 m-0 d-flex justify-content-center px-4 py-5 bg-clr1 overflow-scroll d-none d-md-inherit" style="height:100vh;"></div>
<div class="col-md-3 m-0 d-flex justify-content-center px-4 py-5 bg-clr1 overflow-scroll position-relative position-md-fixed" style="height:100vh;" id="navbar-admin">
    <div class="position-absolute pb-5 mb-5 mx-2">
        <div class="row m-0 p-0">
            ...
            <div class="col-10 m-0 p-0 d-flex align-items-center">
                <div class="d-flex align-items-center">
                    <div class="ms-3">
                        <h5 class="text-clr5 d-inline fw-800 ls-xxs mt-0 mb-0">Al-Hikam</h5>
