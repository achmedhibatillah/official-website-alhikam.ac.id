                ...
                <div class="row m-0 p-0">
                    ...
                    <div class="col-md-7 col-lg-7 m-0 p-0 d-flex justify-content-center justify-content-md-start align-items-md-center">
                        <div class="mt-4 mt-md-0">
                            ...
                            <p class="fsz-15 text-secondary lh-1 m-0 text-center text-md-start d-inline position-relative">Status: <?= ($bp['bp_konfirm'] == 1) ? 'Terverifikasi <i class="fas fa-check fsz-12 bg-clr1 text-clr5 p-1 he-20 we-20 d-flex justify-content-center align-items-center rounded-circle position-absolute" style="top:-1px;right:-22px;"></i>' : 'Belum diverifikasi <i class="fas fa-hourglass-half fsz-12 bg-warning text-clr5 p-1 he-20 we-20 d-flex justify-content-center align-items-center rounded-circle position-absolute" style="top:-1px;right:-22px;"></i>' ?></p>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-3 m-0 p-0 d-flex align-items-center justify-content-center">
                        <div class="card bg-clr1 border-clr5 p-2 mt-4 py-3 mt-md-0">
                            <div class="">
                                <?php $file_bp = str_replace('uploads/bp/', '', $bp['bp_bp']); ?>
                                <div class="d-flex justify-content-center">
                                    <a href="<?= base_url('admin-download-bukti-pembayaran/' . $file_bp) ?>" class="text-clr5 text-center ls-s lh-1 fsz-12 mb-0"><i class="fas fa-download me-2"></i> lihat dokumen bukti pembayaran di sini</a>
                                </div>
                                <div class="d-flex justify-content-center">
