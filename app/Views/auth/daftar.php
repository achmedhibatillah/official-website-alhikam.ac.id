<section class="bg-clr5 bg-web position-relative row bg-danger m-0 p-0 justify-content-center" style="min-height:100vh;background-image:url('<?= base_url('images/bg-auth.png') ?>');">
    <div class="col-11 col-md-7 col-lg-4 m-0 p-0 d-flex justify-content-center align-items-center">
        <div class="card mx-0 p-0 border-clr1-3 position-relative w-100" style="border-radius:20px;margin:80px 0;">
            ...
            <div class="card-body p-0 text-clr1" style="margin:38px;">
                ...
                <form action="<?= base_url('registration') ?>" method="post">
                    ...
                    <div class="row m-0 p-0 mb-3">
                        <div class="col-6 m-0 p-0 pe-1 d-flex align-items-end">
                            <div>
                                ...
                                <input name="username" type="number" autocomplete="off" class="form-control input-clr3 ps-3 py-2 mt-0 fsz-13 <?= session()->getFlashdata('errors-daftar') && isset(session()->getFlashdata('errors-daftar')['username']) ? 'is-invalid' : '' ?>" id="username" placeholder="No Telp/WA" value="<?= old('username') ?>">
                            </div>
                        </div>
                        <div class="col-6 m-0 p-0 d-flex align-items-end">
                            <div>
                                <label for="username" class="form-label mb-0 fsz-14 ls-1 fw-bold">Email</label>
                                <input name="email" type="text" autocomplete="off" class="form-control input-clr3 ps-3 py-2 mt-0 fsz-13 <?= session()->getFlashdata('errors-daftar') && isset(session()->getFlashdata('errors-daftar')['email']) ? 'is-invalid' : '' ?>" id="username" placeholder="Email" value="<?= old('email') ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input name="nama" type="text" autocomplete="off" class="form-control input-clr3 ps-3 py-2 mt-0 fsz-13 <?= session()->getFlashdata('errors-daftar') && isset(session()->getFlashdata('errors-daftar')['nama']) ? 'is-invalid' : '' ?>" id="nama" placeholder="Nama Lengkap" value="<?= old('nama') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="ktp" type="number" autocomplete="off" class="form-control input-clr3 ps-3 py-2 mt-0 fsz-13 <?= session()->getFlashdata('errors-daftar') && isset(session()->getFlashdata('errors-daftar')['ktp']) ? 'is-invalid' : '' ?>" id="ktp" placeholder="16 digit" value="<?= old('ktp') ?>">
                    ...
                    <div class="mb-1">
                        <div class="row m-0 p-0">
                            <div class="col-6 m-0 p-0 pe-1 d-flex align-items-end">
                                <div>
                                    <label for="pass" autocomplete="off" class="form-label mb-0 fsz-14 ls-1 lh-xs fw-bold">Password</label>
                            ...
                            <div class="col-6 m-0 p-0 d-flex align-items-end">
                                <div>
                                    ...
                                    <div class="input-group">
                                        <input name="pass2" autocomplete="off" type="password" class="form-control input-clr3 ps-3 py-2 mt-0 fsz-13 <?= session()->getFlashdata('errors-daftar') && isset(session()->getFlashdata('errors-daftar')['pass2']) ? 'is-invalid' : '' ?>" id="pass2" placeholder="Password" value="<?= old('pass2') ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
