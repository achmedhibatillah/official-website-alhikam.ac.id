            ...
            <div class="card-body p-0 text-clr1" style="margin:38px;">
                ...
                <form action="<?= base_url('authentication-admin') ?>" method="post">
                    <div class="mb-3">
                        ...
                        <input name="username" type="number" class="form-control ps-3 py-2 mt--1 fsz-13 <?= session()->getFlashdata('errors-masuk') && isset(session()->getFlashdata('errors-masuk')['username']) ? 'is-invalid' : '' ?>" id="username" placeholder="Username" value="<?= old('username') ?>">
